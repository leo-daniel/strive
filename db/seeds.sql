...
VALUES ('Pay my credit card bill', 'Home', NULL, NULL, 0, NULL, 1, NULL);

INSERT INTO tasks (`task_name`, `category`, `address`, `description`, `priority`, `date_due`, 'is_complete', `hours_complete`)
VALUES ('Add custom emoji to the company Slack workspace', 'Work', NULL, 'This is a vauluable task that I should make a top priority', 3, NULL, 0,  8);

INSERT INTO tasks (`task_name`, `category`, `address`, `description`, `priority`, `date_due`, 'is_complete', `hours_complete`)
VALUES ('Write code for to-do app', 'Work', NULL, 'Node.js, Handlebars, Express, Sequelize, Heroku', 2, NULL, 0, 20);

INSERT INTO tasks (`task_name`, `category`, `address`, `description`, `priority`, `date_due`, 'is_complete', `hours_complete`)
VALUES ('Uncategorized task', NULL, NULL, NULL, 1, NULL, 0, NULL);
